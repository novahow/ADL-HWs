...
def main(args):
    ...
    for epoch in range(args.num_epoch):
        ...
        for step, batch in enumerate(pbar):
            ...
            batch_rb = torch.tensor([(e['rouge-l']['f'] + e['rouge-2']['f'] + e['rouge-1']['f']) for e in Rbase], device=device)# \
            ...
            if best_rew >= 0.05:
                ...
                batch_rs = torch.tensor([(e['rouge-l']['f'] + e['rouge-2']['f'] + e['rouge-1']['f']) for e in Rsamp], device=device)
                # implement baseline
